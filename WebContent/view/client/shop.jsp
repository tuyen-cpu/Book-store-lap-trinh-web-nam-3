						...
						<div class="tab-content fix">
													...
													<div class="pro-actions">
														...
														<div class="actions-secondary">
															<!-- <a href="#" title="Compare"><i
																...
																href="${pageContext.request.contextPath}/ThemYeuThich?Add=${sach.maSach}" title="WishList"><i
							...
							<div class="pro-pagination">
								...
								<c:forEach begin="1" end="${trangCuoi}" var="i">  
									...
									<li class="${i==index?'active':''}"><a href="${pageContext.request.contextPath}/DanhSachSach?index=${i}&danhmuc=${danhMuc}" >${i}</a></li>
